<?php # inc/migrations/migration_projects.php v:1.2.0 d:2026-08-11 i:evs 
/**
...
$migration_key = 'add_projects_module_v1';

// --- Tjek om grundmigrationen er kørt ---
$check = DB::query($conn, "SELECT id FROM system_migrations WHERE migration_key = '$migration_key'");
if (DB::num_rows($check) === 0) {
    echo "❌ Grundmigrationen '$migration_key' er ikke kørt endnu. Kør v1.2.0 først.\n";
    exit;
}
